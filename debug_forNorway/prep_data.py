...
gdf = gpd.read_file('/home/nibio/DPCR-AGB/debug_forNorway/test/rand_gen_points_clean.gpkg')
#gdf = gdf.rename(columns={'las_file': 'pt_file'})

new_path = "/home/nibio/DPCR-AGB/debug_forNorway/test/als_plots/"
...
gdf['V_ha'] =gdf['SRRVOLMB_1']

print(gdf)

# Export
gdf.to_file('/home/nibio/DPCR-AGB/debug_forNorway/test/rand_gen_points_clean_mod.gpkg', driver='GPKG')
...
# Save to CSV files
train_df[columns].to_csv('/home/nibio/DPCR-AGB/debug_forNorway/test/train_split.csv', index=False)
test_df[columns].to_csv('/home/nibio/DPCR-AGB/debug_forNorway/test/test_split.csv', index=False)
val_df[columns].to_csv('/home/nibio/DPCR-AGB/debug_forNorway/test/val_split.csv', index=False)