...
for las_file in os.listdir(las_dir):
    if las_file.endswith(".las"):  # Check if the file is a LAS file
...
las_file_path = "/home/nibio/DPCR-AGB/torch-points3d/data/biomass/raw/2014/region1/gen_rand_plot_1.las"
